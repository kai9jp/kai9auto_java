...
public class Api {
    ...
    // 一時テスト用
    @PostMapping(value = "/api/auto_exec_test", produces = "application/json;charset=utf-8")
    @ResponseBody
    public void auto_exec_test(HttpServletResponse res, HttpServletRequest request) throws CloneNotSupportedException, IOException, JSONException, SQLException {
//  		AnsibleExec AnsibleExec = context.getBean(AnsibleExec.class);
//  		AnsibleExec.exec(null);

//		AutoExec AutoExec = context.getBean(AutoExec.class);
//  		AutoExec.Exec(4);
